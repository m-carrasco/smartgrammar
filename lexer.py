...
t_SMARTCAST_INTERRUPT_PREVIOUS=r'SMARTCAST_INTERRUPT_PREVIOUS'
t_SMARTCAST_TRIGGERED=r'SMARTCAST_TRIGGERED'
t_SMARTCAST_AURA_NOT_PRESENT=r'SMARTCAST_AURA_NOT_PRESENT'
t_SMARTCAST_COMBAT_MOVE=r'SMARTCAST_COMBAT_MOVE'

t_SMART_TARGET_NONE=r'SMART_TARGET_NONE'
t_SMART_TARGET_SELF=r'SMART_TARGET_SELF'
t_SMART_TARGET_VICTIM=r'SMART_TARGET_VICTIM'
t_SMART_TARGET_HOSTILE_SECOND_AGGRO=r'SMART_TARGET_HOSTILE_SECOND_AGGRO'
t_SMART_TARGET_HOSTILE_LAST_AGGRO=r'SMART_TARGET_HOSTILE_LAST_AGGRO'
t_SMART_TARGET_HOSTILE_RANDOM=r'SMART_TARGET_HOSTILE_RANDOM'
t_SMART_TARGET_HOSTILE_RANDOM_NOT_TOP=r'SMART_TARGET_HOSTILE_RANDOM_NOT_TOP'
t_SMART_TARGET_ACTION_INVOKER=r'SMART_TARGET_ACTION_INVOKER'
t_SMART_TARGET_POSITION=r'SMART_TARGET_POSITION'
t_SMART_TARGET_CREATURE_RANGE=r'SMART_TARGET_CREATURE_RANGE'
t_SMART_TARGET_CREATURE_GUID=r'SMART_TARGET_CREATURE_GUID'
t_SMART_TARGET_CREATURE_DISTANCE=r'SMART_TARGET_CREATURE_DISTANCE'
t_SMART_TARGET_STORED=r'SMART_TARGET_STORED'
t_SMART_TARGET_GAMEOBJECT_RANGE=r'SMART_TARGET_GAMEOBJECT_RANGE'
t_SMART_TARGET_GAMEOBJECT_GUID=r'SMART_TARGET_GAMEOBJECT_GUID'
t_SMART_TARGET_GAMEOBJECT_DISTANCE=r'SMART_TARGET_GAMEOBJECT_DISTANCE'
t_SMART_TARGET_INVOKER_PARTY=r'SMART_TARGET_INVOKER_PARTY'
t_SMART_TARGET_PLAYER_RANGE=r'SMART_TARGET_PLAYER_RANGE'
t_SMART_TARGET_PLAYER_DISTANCE=r'SMART_TARGET_PLAYER_DISTANCE'
t_SMART_TARGET_CLOSEST_CREATURE=r'SMART_TARGET_CLOSEST_CREATURE'
t_SMART_TARGET_CLOSEST_GAMEOBJECT=r'SMART_TARGET_CLOSEST_GAMEOBJECT'
t_SMART_TARGET_CLOSEST_PLAYER=r'SMART_TARGET_CLOSEST_PLAYER'
t_SMART_TARGET_ACTION_INVOKER_VEHICLE=r'SMART_TARGET_ACTION_INVOKER_VEHICLE'
t_SMART_TARGET_OWNER_OR_SUMMONER=r'SMART_TARGET_OWNER_OR_SUMMONER'
t_SMART_TARGET_THREAT_LIST=r'SMART_TARGET_THREAT_LIST'
t_SMART_TARGET_CLOSEST_ENEMY=r'SMART_TARGET_CLOSEST_ENEMY'
t_SMART_TARGET_CLOSEST_FRIENDLY=r'SMART_TARGET_CLOSEST_FRIENDLY'
...
def t_NUMBER(t):
    ...
    if t.value.isdigit():
        ...
        number_type = "float"
    t.value = {"value": number_value, "type": number_type}
    return t
